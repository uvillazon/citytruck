...
//        me.fbar = me.toolbar;
        //        me.bar = this.bbar;Ext.PagingToolbar
        me.viewConfig = {
        ...
        me.columns = [
            ...
            { header: "Fecha", width: 90, sortable: false, dataIndex: "FECHA", renderer: Ext.util.Format.dateRenderer('d/m/Y') },
            { header: "Ventas (Lts)", width: 80, sortable: false, dataIndex: "VENTA_TOTAL", align: "right" },
            { header: "Turno<br>Dia", width: 80, sortable: false, dataIndex: "VENTA_DIA", align: "right" },
            { header: "Turno<br>Tarde", width: 80, sortable: false, dataIndex: "VENTA_TARDE", align: "right" },
            { header: "Turno<br>Noche", width: 80, sortable: false, dataIndex: "VENTA_NOCHE", align: "right" }
        ];
