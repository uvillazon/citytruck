        ...
        me.columns = [
            ...
            { text: 'DIESEL OIL',
              columns: [
                ...
                { header: "S-INICIAL", width: 100, sortable: false, dataIndex: "SALDO_INICIAL_DIE", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "COMPRAS", width: 100, sortable: false, dataIndex: "COMPRAS_DIE", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "VENTAS", width: 100, sortable: false, dataIndex: "VENTAS_DIE", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "AJUSTES", width: 100, sortable: false, dataIndex: "AJUSTES_DIE", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "ACUM.", width: 100, sortable: false, dataIndex: "ACUMULADO_DIE", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00')}]
          },
           { text: '', width: 20 },
          { text: 'GASOLINA ESPECIAL',
              columns: [
                { header: "FECHA", width: 100, sortable: true, dataIndex: "FECHA", renderer: Ext.util.Format.dateRenderer('d/m/Y') },
                { header: "S-INICIAL", width: 100, sortable: false, dataIndex: "SALDO_INICIAL_GAS", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "COMPRAS", width: 100, sortable: false, dataIndex: "COMPRAS_GAS", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "VENTAS", width: 100, sortable: false, dataIndex: "VENTAS_GAS", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "AJUSTES", width: 100, sortable: false, dataIndex: "AJUSTES_GAS", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00') },
                { header: "ACUM.", width: 100, sortable: false, dataIndex: "ACUMULADO_GAS", align: "right", renderer: Ext.util.Format.numberRenderer('0,000.00')}]
          }
        ];
