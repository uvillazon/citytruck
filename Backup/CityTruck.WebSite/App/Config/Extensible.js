 ...
 * @singleton
 */
Ext.define('App.Config.Extensible', {
    alternateClassName: "Extensible",
    singleton: true,
    ...
    changeLang: function (code) {
        var me = this;
        me.doLoad(Constantes.HOST + 'App/extensible/locale/extensible-lang-' + code + '.js', function (resp, opts) {
