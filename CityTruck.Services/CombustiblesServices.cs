...
namespace CityTruck.Services
{
    public class CombustiblesServices : BaseService, ICombustiblesServices
    {
        ...
        public SG_AJUSTES_TANQUE ObtenerAjusteTanque(System.Linq.Expressions.Expression<Func<SG_AJUSTES_TANQUE, bool>> criterio = null)
        {
            SG_AJUSTES_TANQUE result = null;
            ExecuteManager(uow =>
            {
                var manager = new SG_AJUSTES_TANQUEManager(uow);
